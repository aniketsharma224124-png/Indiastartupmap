...
// Only visible at ≥1280px via CSS class ism-ad-left / ism-ad-right
...
function SponsorCard({ ad }) {
  ...
  return (
    <a href={ad.url} target="_blank" rel="noopener noreferrer"
      ...
      <div style={{ width: 32, height: 32, borderRadius: 8, background: ad.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 5px', overflow: 'hidden' }}>
        {ad.logo_url && !imgErr
...
function AdvertiseSlot() {
  ...
  return (
    <div
      ...
      <div style={{ fontFamily: 'DM Sans,system-ui,sans-serif', fontSize: 8.5, color: '#9ca3af' }}>₹499/month</div>
    </div>
  )
}
...
// ── EXPORTS ───────────────────────────────────────────────────────────────────
export function LeftAdPanel() { return <Panel pool={LEFT_ADS} /> }
export function RightAdPanel() { return <Panel pool={RIGHT_ADS} /> }
